...
{		
	...
	public:
		...
		TEST_METHOD(lessThan448BitsASM){
			//case l<448 bit
			//before
			std::ofstream l448;
			l448.open("l448.txt");
		...
		TEST_METHOD(moreThan448BitsASM){
			//case l > 448
			//before
			std::ofstream m448;
			m448.open("m448.txt");
		...
		TEST_METHOD(moreThan512BitsASM){
			//case l > 512
			//before
			std::ofstream m512;
			m512.open("m512.txt");
